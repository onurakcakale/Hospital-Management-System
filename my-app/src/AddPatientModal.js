...
export class AddPatientModal extends Component{
    ...
    savePersonel = async (e) => {
        ...
        const res = await axios.post('http://localhost:5000/api/patient', this.state)
        .then(res => {
                            ...
                            <Col>
                                <Form onSubmit = { this.savePersonel }>
                                    ...
                                    <Form.Group controlId = "insurance">
                                        ...
                                        <Form.Control type = "text" name = "insurance" required onChange={this.handleInput} value={this.state.insurance} /> <br></br>
                                    </Form.Group>
